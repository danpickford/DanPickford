...
Q.load("../../Content/Images/About/aboutSprite.png, ../../Content/JSON/sprites.json, ../../Content/JSON/level1.json, ../../Content/JSON/level2.json, ../../Content/Images/About/tiles.png, ../../Content/Images/About/tiles2.png", function () {
