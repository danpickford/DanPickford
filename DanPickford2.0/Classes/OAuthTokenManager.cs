...
namespace DanPickford2._0.Classes
{
    public class OAuthTokenManager : IConsumerTokenManager, IOpenIdOAuthTokenManager
    {
        private Dictionary<string, string> tokensAndSecrets = new Dictionary<string, string>();

        public OAuthTokenManager(string consumerKey, string consumerSecret)
        {
